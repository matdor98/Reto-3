...
public class AddUserForm extends javax.swing.JDialog {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(name.isEmpty() || lastname.isEmpty() || document.isEmpty() || email.isEmpty()){
            ...
            String queryNuevoEmpleado = "INSERT INTO `empleado`(`nombreEmp`, `apellidos`, `tipoDocumento`, `documento`, `correo`,`FK_idSucursal`) VALUES ('"+name+"','"+lastname+"','"+documentType+"','"+document+"','"+email+"',1);";
